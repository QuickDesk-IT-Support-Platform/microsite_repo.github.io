...
{/* 
        ...
        <span className='mt-5 max-w-3xl text-center text-xl'>Desenvolvimento de uma plataforma web de gestão de serviços de IT para otimização de processos de suporte, com portal self-service, automação de tickets e dashboards em tempo real.</span>
